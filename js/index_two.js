...
class Animal {
  ...
  class Dog extends Animal {
    constructor(eyes, legs, mouth, breed) {
      super(eyes, legs, mouth); // call the constructor that is coming from the Animal class
      this.breed = breed;
    }
...
React.createElement(
  ...
  [...children] // this specifies what should between the opening tag and 
  closing tag of an element 
)
<button id="click-button" class="btn" style="background: red" 
onclick="">Click to Reveal</button>
*/
